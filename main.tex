...
\departamento{Seção de Engenharia de Defesa}
...
\begin{fichacatalografica}
	...
	\hspace{0.5cm} \parbox[t]{\textwidth}{\imprimirtipotrabalho~--~\imprimirinstituicao \par
	\imprimirdepartamento \par
	\imprimirprogramaoudepartamento, \imprimirdata.\par} 
