...
\coorientador{Jauvane Cavalcante de Oliveira}
\instituicao{%
...
\preambulo{\imprimirtipotrabalho\space apresentada ao Programa de Pós-graduação em Engenharia de Defesa do Instituto Militar de Engenharia, como requisito parcial para a obtenção do título de Doutor em Ciência em Engenharia de Defesa.}
% ---
...
% Programa de PG ou Departameto da Graduação
\instituicao{Programa de Pós-graduação em Engenharia de Defesa}
% \programaoudepartamento{Programa de Pós-graduação em Engenharia de Defesa}
% Tese de Doutorado, Dissertação de Mestrado, Projeto de Fim de Curso, Exame de Qualificação, Proposta de Tese, Proposta de Dissertação
\tipotrabalho{Tese de Doutorado} 
\titulopretendido{Doutor em Ciência em Engenharia de Defesa}
\preambulo{\imprimirtipotrabalho\space apresentada ao \imprimirinstituicao\space do Instituto Militar de Engenharia, como requisito parcial para a obtenção do título de \imprimirtitulopretendido.}
% ---
...
\begin{fichacatalografica}
	...
	\hspace{0.5cm} \imprimirorientadorRotulo~\imprimirorientador\par
...
\begin{folhadeaprovacao}
 ...
 \end{center}
      \begin{flushleft}
      Aprovado em \imprimirlocal, 22 de março de \imprimirdata, pela seguinte banca examinadora:
      \end{flushleft}
